...
\begin{tabular}{rl}
 ...
 VUMOS & Sistema de Monitoramento de Vulnerabilidades (\emph{Vulnerability Monitoring System})\\
  ...
  CIRD & Roteamento entre domínios sem classes (\emph{Classless Inter-Domain Routing})\\
   ...
   CVE & Vulnerabilidades e Exposições Comuns (\emph{Common Vulnerabilities and Exposures})\\
  CVSS & Sistema de Pontuação de Vulnerabilidades Comuns (\emph{Common Vulnerability Scoring System})\\
